...
<body>
    ...
    <div class="container">
        <h2 class="container_head" style="color:grey">Enter details</h2>
        <hr>
        <form action="insert_t.php" method="post">
	    <input type="text" class="textfields" name="tid" placeholder="Theatre ID" required>
            <br><br>
            <input type="text" class="textfields" name="tname" placeholder="Theatre Name" required>
            <br><br>
            <input type="text" class="textfields" name="tlocation" placeholder="Theatre Location" required>
            <br><br>
            <input type="text" class="textfields" name="tcapacity" placeholder="Theatre Capacity" required>
            <br><br>
            <input type="text" class="textfields" name="tscreens" placeholder="Theatre Screens" required>
            <br><br>
            <input type="text" class="textfields" name="towner" placeholder="Theatre Owner" required>
            <br><br>
            <button type="submit" id="sbutton">Add Theatre</button>
        </form>     
    </div>
    <div class="the_disp">
        <?php
